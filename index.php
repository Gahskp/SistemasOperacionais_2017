...
<head>
    ...
    if (isset($_POST['email'])) {
        ...
        if (!$bd->inserirContato($nome, $telefone, $email, $assunto, $mensagem)) {
            echo "<script>alert('Erro ao guardar as informações no banco de dados');</script>";
        }
        //send email
...
<section id="edital">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 title-edital">
                <div class="fb-page" data-href="https://www.facebook.com/MasterAlimentosJr/" data-tabs="timeline"
                     data-width="500" data-height="400" data-small-header="true" data-adapt-container-width="true"
                     data-hide-cover="false" data-show-facepile="true">
                    <div class="fb-xfbml-parse-ignore">
                        <blockquote cite="https://www.facebook.com/MasterAlimentosJr/"><a
                                    href="https://www.facebook.com/MasterAlimentosJr/">Master Alimentos</a></blockquote>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-8">
                        <form method="post">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control formulario" placeholder="Numero de Telefone"
                                       name="telefone">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <textarea class="form-control formulario" rows="4" placeholder="Mensagem"
